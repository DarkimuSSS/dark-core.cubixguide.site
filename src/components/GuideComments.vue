          ...
          <div class="flex items-center justify-between gap-3 mb-3">
            <div class="flex items-center gap-2.5 flex-wrap">
              ...
              <img 
                ...
                class="w-8 h-8 rounded-xl shrink-0 object-cover border border-[#26292d] shadow-sm" 
              />
              <div v-else class="w-8 h-8 rounded-xl shrink-0 bg-gradient-to-tr from-slate-700 to-slate-800 border border-[#26292d] flex items-center justify-center text-white text-xs font-bold shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 mb-2">
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <img 
                  ...
                  class="w-6 h-6 rounded-lg shrink-0 object-cover border border-[#26292d]" 
                />
                <div v-else class="w-6 h-6 rounded-lg shrink-0 bg-slate-700 flex items-center justify-center text-white text-[10px] font-bold">
