...
import BloodMagicAltar3DVisualizer from './BloodMagicAltar3DVisualizer.vue';
import {
  BLOOD_MAGIC_RUNES,
  BLOOD_MAGIC_TIERS,
...
<template>
  <div class="min-h-screen bg-[#0c0d0e] text-[#e2e8f0] pb-16">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 space-y-6">
      ...
      <!-- 3. FULL 3D VOXEL ALTAR VISUALIZER (Tier 1 to 6) -->
      <BloodMagicAltar3DVisualizer :tier="selectedTier" />
