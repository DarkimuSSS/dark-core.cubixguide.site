...
const steps = [
  {
    ...
    description: 'Обратитесь к кураторам вики или администрации сервера CubixWorld для получения персонального инвайт-кода.'
  },
  {
    number: '02',
...
const perks = [
  { icon: 'Award', title: 'Официальный статус', desc: 'Уникальный бейдж проверенного автора в профиле и статьях' },
