...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fadeIn">
    ...
    <div class="relative w-full max-w-2xl">
      ...
      <div class="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 z-50 flex flex-col gap-2.5 items-center">
        ...
        <div v-if="isAdmin" class="relative group/tool">
          <button
            ...
            class="w-10 h-10 rounded-2xl bg-[#0c0d0e] hover:bg-purple-950/60 text-purple-400 border-2 border-purple-500/80 hover:border-purple-400 flex items-center justify-center shadow-2xl hover:scale-110 transition-all cursor-pointer"
          >
            <IconRenderer name="Shield" size="18" class="stroke-[2]" />
          </button>
          <div class="absolute right-full top-1/2 -translate-y-1/2 mr-3 hidden group-hover/tool:flex items-center pointer-events-none">
      ...
      <div class="bg-[#16181a] border border-[#26292d] w-full rounded-3xl shadow-2xl space-y-6 max-h-[85vh] overflow-y-auto custom-scrollbar relative overflow-hidden">

        <!-- CUSTOM AUTHOR COVER BANNER AT THE TOP OF THE MODAL -->
        <div class="h-32 sm:h-40 w-full relative overflow-hidden bg-gradient-to-r from-emerald-950 via-[#181d22] to-purple-950 border-b border-[#26292d]">
          <img
        ...
        <!-- Modal Inner Padding Content Container -->
        <div class="p-6 sm:p-8 pt-0 -mt-12 sm:-mt-14 relative z-10 space-y-6">
          ...
          <template v-else>
            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 pb-6 border-b border-[#26292d]">
              <!-- Avatar with Glow Overlapping the Banner -->
              <div class="relative flex-shrink-0">
                <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-tr from-emerald-600 via-cyan-500 to-purple-600 p-0.5 shadow-2xl shadow-emerald-950/80 overflow-hidden ring-4 ring-[#16181a]">
              ...
              <!-- Profile Details -->
              <div class="space-y-3 text-center sm:text-left flex-1 min-w-0 pr-8 pt-2 sm:pt-14">
            ...
            <div v-if="isEditing" class="space-y-4 bg-[#0c0d0e] border border-[#26292d] p-5 rounded-2xl">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <!-- BANNER SETTINGS -->
                <div>
                  <label class="block text-[11px] text-purple-300 font-medium mb-1">Ссылка на Баннер Шапки (URL)</label>
                  <input
                    type="text"
